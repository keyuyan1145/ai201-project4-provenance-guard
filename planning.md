...
### Edge case 4 — Very short content (under ~80 words)
...
**Mitigation:** Heuristic sub-scores should be capped or discounted for texts under a minimum length threshold (configurable, default: 80 words). Document this limitation in the README.
